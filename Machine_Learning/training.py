...
Settings = {
            ...
            "ModelTrainingName"     : "DualEncoder_WGAN_XavierInit_30_epochs",
...
Settings = {
            ...
            "RestoreModel"          : False,
            #No spaces in the model name, please use '_'
            "ModelTrainingName"     : "TESTDELEME",
            "Drop_incomplete_batch" : True,
            "Num_training_samples"  : 0.01, #[None] for all available images or float [0,1] for a fraction of total images
            "Pin_memory"            : True
            }
