...
Settings = {
            ...
            "ModelTrainingName"     : "DualEncoder_WGAN_XavierInit_40_epochs",
...
Settings = {
            ...
            "Drop_incomplete_batch" : True,
            "Num_training_samples"  : 0.001, #[None] for all available images or float [0,1] for a fraction of total images
            "Pin_memory"            : True
            }
...
if __name__ == '__main__':
    ...
    if input("Would you like to load a previous model[y/n] ?: ") == "y":
        ...
        init_weights(Discriminator, init_gain=1, init_type="xavier")
        Generator = Generator_Defect_GAN().to(device)
        init_weights(Generator, init_gain=1, init_type="xavier")
