...
class Training_Framework():
    ...
    def Create_graphs(self):
        ...
        plt.plot(xaxis, np.log10(self.Generator_loss_train), label="Generator loss training")
        plt.plot(xaxis, np.log10(self.Generator_loss_validation), label="Generator loss validation")
        plt.xlabel("epochs")
        plt.ylabel("Loss [dB]")
        ...
        plt.plot(xaxis, np.log10(self.Discriminator_loss_train), label="Discriminator loss training")    
        plt.plot(xaxis, np.log10(self.Discriminator_loss_validation), label="Discriminator loss validation")
        plt.xlabel("epochs")
        plt.ylabel("Loss [dB]")
